...
void ACSkill_Thron::ReceiveParticleData_Implementation(const TArray<FBasicParticleData>& Data, UNiagaraSystem* NiagaraSystem)
{
		...
		if (CollisionMesh)
		{
			...
			UKismetSystemLibrary::BoxTraceMultiForObjects(GetWorld(), location, location, extent, FRotator::ZeroRotator, objects, false, ignores, EDrawDebugTrace::None, hitResults, true);
